        ...
        <div class="container">
            <div class="row justify-content-between gy-5">
                <div
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">Jai Sang Ma Restaurant. More than 3 years of cooking
                        experience. Ensure deliciousness and is hygienic.</p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-7 position-relative about-img"
                        style="background-image: url(frontend/assets/img/about.jpg) ;" data-aos="fade-up"
                        data-aos-delay="150">
                    ...
                    <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <p>
                                Jai Sung Ma is cooked to order dish restaurant. There are many menus. Comfortable seats,
                                good music, parking.
                            </p>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="why-box">
                            ...
                            <p>
                                Because Jai Sung Ma restaurant more than 3 years of experience in cooking. We care about
                                quality,sanitary and deliciousness.
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="tab-pane fade" id="menu-breakfast">
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-1.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-1.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-2.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-2.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Pepsi</h4>
                                <p class="ingredients">
                                    Vol. 640 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-3.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-3.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Sprite lemon</h4>
                                <p class="ingredients">
                                    Vol. 450 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-4.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-4.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Leo Beer</h4>
                                <p class="ingredients">
                                    Vol. 620 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-5.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-5.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Chang Beer</h4>
                                <p class="ingredients">
                                    Vol. 640 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-6.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-6.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Singha Beer</h4>
                                <p class="ingredients">
                                    Vol. 620 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-7.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-7.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                <h4>Heineken</h4>
                                <p class="ingredients">
                                    Beer Vol. 620 ml.
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menuD-8.png') }}" class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menuD-8.png') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="testimonial-content">
                                            <p>
                                                ...
                                                เลือกเลยครับไม่ต้องกลัวไม่อร่อย อร่อยหมดเลยครับ แนะนำไข่เจียวห่อหมก กับ
                                                ข้าวผัดมันกุ้งครับ อยากให้ลอง อาหารอร่อย
                    ...
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery-8.jpg') }}"><img
                                    ...
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery-9.jpg') }}"><img
                                    src="{{ asset('frontend/assets/img/gallery/gallery-9.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="mb-3">
                    <iframe style="border:0; width: 100%; height: 350px;"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.64657326533!2d100.65654855092863!3d14.038951894307228!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311d7fea5531e373%3A0xb7b2c0c99a57c11d!2z4Lij4LmJ4Liy4LiZ4LmD4LiI4Liq4Lix4LmI4LiH4Lih4Liy!5e0!3m2!1sth!2sth!4v1674741494973!5m2!1sth!2sth"
                ...
                <form action="{{ asset('frontend/forms/contact.php') }}" method="post" role="form"
            ...
            <div class="row gy-3">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <div class="social-links d-flex">
                        <a href="https://www.facebook.com/profile.php?id=100063650880883" target="_blank"
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        <div class="container">
                            ...
                            <p class=" text-muted">Information Technology <a
                                    href="https://www3.pongsawadi.ac.th/psc2023/" target="_blank"
